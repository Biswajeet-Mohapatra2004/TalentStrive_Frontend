...
const UserProfile = (props) => {
    ...
    const [resumeExists, setResumeExists] = useState(!!resume);
    ...
    return (
        <div className="flex flex-col md:flex-row items-start justify-around mt-10 mb-20 gap-8 px-4">
            {/* Profile and Resume Section */}
            <div className="flex flex-col gap-y-8 w-full md:w-1/2 max-w-lg">
                {/* Profile Section */}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-lg">
                                {application.length === 0 ? "No applications yet" : application.length}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-gray-800 text-white shadow-lg rounded-lg p-8">
                    ...
                    {resumeExists ? (
                        <div className="flex flex-col items-center">
                            <h2 className="text-amber-50 text-center text-lg mb-4">{resumeStatus}</h2>
                        ...
                        <h2 className="text-amber-50 text-center text-lg">{resumeStatus}</h2>
                    )}
                </div>
            </div>

            {/* Skills Section */}
            <div className="bg-gray-800 gap-x-3 text-white shadow-lg rounded-lg p-8 w-full md:w-1/2 max-w-lg">
                <h3 className="text-2xl font-bold text-center mb-4">Skills</h3>
                {skill.length === 0 ? (
                    <h2 className="text-center text-gray-400">Upload a resume to extract skills.</h2>
                ) : (

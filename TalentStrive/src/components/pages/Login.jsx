...
const LoginEMP = () => {
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-black to-gray-900 flex flex-col items-center justify-center text-white">
            ...
            <p className="mt-6 text-gray-400">Don't have an account? <a href="/user/register" className="text-purple-400 hover:underline">Sign up</a></p>
            <p className="mt-6 text-gray-400">Sign in as employer? <a href="/employer/login" className="text-purple-400 hover:underline">Log in</a></p>
        </div>
    );
};
